...
def main():
    ...
    if args.ex >= 5:
        ...
        _, df_pts = ex5.fun_total_points(data_with_points)
    ...
    if args.ex >= 7:
        print("\n[EX7] Ejercicio 7: Grafo de conexiones top 5 equipos")
        print("-" * 60)
        top5 = df_pts.head(5).index.tolist()
        print(f"Top 5 equipos seleccionados: {top5}\n")
        img_path = ex7.graf(data_with_points, top5)
        print(f"Gráfica guardada en: {img_path}")
